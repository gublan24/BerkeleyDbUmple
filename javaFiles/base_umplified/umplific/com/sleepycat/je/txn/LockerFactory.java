...
public class LockerFactory
{
   ...
   * @param retainNonTxnLocks is true for DbTree operations, so that thehandle lock may be transferred out of the locker when the operation is complete.
   */
  // line 28 "../../../../LockerFactory.ump"
   public static  Locker getWritableLocker(Environment env, Transaction userTxn, boolean dbIsTransactional, boolean retainNonTxnLocks, TransactionConfig autoCommitConfig) throws DatabaseException{
	...
	if (dbIsTransactional && userTxn == null) {
		...
		throw new DatabaseException("A Transaction cannot be used because the" + " environment was opened"
			+ " non-transactionally");
	    }
