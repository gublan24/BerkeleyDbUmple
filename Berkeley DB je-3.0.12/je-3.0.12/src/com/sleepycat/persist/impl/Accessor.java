 ...
 *
 * $Id: Accessor.java,v 1.6 2006/05/01 05:15:46 mark Exp $
 */
 ...
 *
 * <p>When reading an old format record we must account for the following
 * aberations:</p>
 * <ul>
...
interface Accessor {
     ...
     * Integer.MAX_VALUE for endField.  Fields from super classes are read
     * first.</p>
     *
     ...
     * To read all fields, the endField should be Integer.MAX_VALUE.
     *
