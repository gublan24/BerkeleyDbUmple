 ...
 *
 * $Id: RawField.java,v 1.5 2006/05/08 20:22:42 mark Exp $
 */
...
public interface RawField {
    ...
    /**
     * Returns the type of the field, expanding parameterized types if they
     * were declared for this field.  Generic type parameters are not expanded
     * if running under Java 1.4, in which case this method is equivalent to
     * {@link #getType}.
     */
