 ...
 *
 * $Id: RawObject.java,v 1.6 2006/05/08 20:22:42 mark Exp $
 */
...
/**
 * A raw instance that can be used with a {@link RawStore}, {@link Converter}
 * or {@link ConversionStore}.  A <code>RawObject</code> is used to represent
 * instances of complex types (persistent classes with fields), arrays, and
 * enum values.  It is not used to represent non-enum simple types, which are
 * represented as simple objects.  This includes primitives, which are
 * represented as simple objects using their wrapper class.
 *
...
public class RawObject {
     ...
     * This can only occur in a {@link Converter#convert Converter.convert}
     * mutation method or when using a {@link ConversionStore}.</p>
     */
