 ...
 *
 * $Id: RawStore.java,v 1.8 2006/05/09 05:47:07 mark Exp $
 */
 ...
 * changed.</li>
 * <li>The application's persistent classes are not required to be available,
 * with one exception: Composite key classes that implement the {@code
 * Comparable} interface must be present, in order to perform key
 * comparisons.</li>
 * </ol>
 *
 * @author Mark Hayes
...
public class RawStore {
     ...
     * {@link Mutations} for more information.
     *
    ...
    public SecondaryIndex<Object,Object,RawObject>
        ...
        return store.getSecondaryIndex
            (getPrimaryIndex(entityClass), entityClass, Object.class, null,
             keyName);
    }
     ...
     * derived from the configured entity model object and the live entity
     * class definitions.
     */
    ...
    /**
     * Returns the complete set of active mutations for this store, including
     * mutations configured when this store was opened and those configured and
     * stored previously.
     */
