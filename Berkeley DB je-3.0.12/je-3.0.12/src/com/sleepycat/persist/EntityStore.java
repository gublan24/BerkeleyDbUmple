 ...
 *
 * $Id: EntityStore.java,v 1.20 2006/05/24 20:49:38 mark Exp $
 */
...
public class EntityStore {
     ...
     *
     * @throws IllegalArgumentException if the given key class or key name is
    ...
    public <SK,PK,E> SecondaryIndex<SK,PK,E>
        ...
        return store.getSecondaryIndex
            (primaryIndex, primaryIndex.getEntityClass().getName(),
     ...
     * normal access to the store.  See {@link Mutations} for more information
     * on class evolution.
     *
     ...
     * {@link Mutations} are deleted.  Therefore, if this method is called
     * twice successfully, the second call will do nothing.</p>
     */
