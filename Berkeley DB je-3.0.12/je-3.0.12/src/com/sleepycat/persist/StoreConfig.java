 ...
 *
 * $Id: StoreConfig.java,v 1.7 2006/05/08 20:22:41 mark Exp $
 */
...
/**
 * Configuration properties used with an {@link EntityStore}, {@link RawStore}
 * or {@link ConversionStore}.
 *
...
public class StoreConfig implements Cloneable {
     ...
     * Mutations} for more information.</p>
     *
     ...
     * will be thrown when creating an {@link EntityStore} or {@link RawStore}.
     * Such exceptions may be suppressed by opening an {@link
     * ConversionStore}, in order to perform manual conversions.</p>
     */
