 ...
 *
 * $Id: ClassEnhancer.java,v 1.10 2006/05/25 01:32:19 mark Exp $
 */
 ...
 * <ol>
 * <li>For Java 1.5, the {@code je.jar} file may be used as an instrumentation
 * agent as follows:
 * <pre class="code">{@literal java -javaagent:lib/je.jar=enhance:packageNames ...}</pre>
...
public class ClassEnhancer implements ClassFileTransformer {
     ...
     * date.  For example:
     *
     * <pre class="code">java -cp je.jar com.sleepycat.persist.model.ClassEnhancer ./classes</pre>
     *
