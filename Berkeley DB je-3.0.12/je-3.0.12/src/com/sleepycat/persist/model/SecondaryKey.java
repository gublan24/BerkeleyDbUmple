 ...
 *
 * $Id: SecondaryKey.java,v 1.5 2006/04/30 14:06:03 mark Exp $
 */
 ...
 * secondary keys may have the same name.  The field name identifies the
 * secondary key and the secondary index for a given entity class, by default.
 * {@link #name} may be specified to override this default.</p>
 *
 ...
 * used) of a secondary key field must following the same rules as for a {@link
...
public @interface SecondaryKey {
     ...
     * entity will be deleted also.  This could in turn trigger further
    ...
    /**
     * Specifies the name of the key that is different from the field name.
     *
     ...
     * keys for a single entity class have the same field name.</p>
     */
    String name() default "";
}
