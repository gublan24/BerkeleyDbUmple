 ...
 *
 * $Id: Entity.java,v 1.5 2006/05/24 20:49:40 mark Exp $
 */
 ...
 *
 * <p>The use of parameterized types (generic types) is allowed.  However, when
 * declaring a field of a generic type, type arguments which are themselves
 * persistent types should be specified.  Additionally, type parameters should
 * not be declared for non-abstract entity classes or subclasses.</p>
 *
 * <p>These restrictions, if followed, enable optimization of class evolution
 * that would not otherwise be possible.  For more information see {@link <a
 * href="../evolve/Mutations.html#genericTypes">Generic Types and Class
 * Evolution</a>}.</p>
 *
...
public @interface Entity {
     ...
     * number to perform class evolution and conversion using {@link Mutations}
     * and {@link ConversionStore}.
     *
