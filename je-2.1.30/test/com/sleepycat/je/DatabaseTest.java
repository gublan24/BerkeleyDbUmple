 ...
 *
 * $Id: DatabaseTest.java,v 1.98 2006/01/03 21:56:11 bostic Exp $
 */
...
public class DatabaseTest extends TestCase {
    ...
    public void testPreloadBytesExceedsCache()
        ...
        /* Create a test db with one record */
        Database myDb = initEnvAndDb(false, false, false, "100000");
        DatabaseEntry key = new DatabaseEntry();
        DatabaseEntry data = new DatabaseEntry();
        key.setData(TestUtils.getTestArray(0));
        data.setData(TestUtils.getTestArray(0));
        ...
        myDb.close();
        env.close();
        myDb = initEnvAndDb(false, false, false, "100000");
