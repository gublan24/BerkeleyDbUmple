 ...
 *
 * $Id: IN.java,v 1.284 2006/01/03 21:55:56 bostic Exp $
 */
...
public class IN extends Node
     ...
     * ChildReference's.  However, for in-memory space savings, we save the
    ...
    ***/
     ...
     * obsolete.
     */
    public void accountForSubtreeRemoval(INList inList,
     ...
     */
    public long logProvisional(LogManager logManager, IN parent)
        throws DatabaseException {
	...
	if (compactLsnsRep) {
        ...
        for (int i = 0; i < nEntries; i++) {
             ...
             * Tree.insert.  [#13126]
             */
	    assert !(getLsn(i) == DbLsn.NULL_LSN &&
                     (entryStates[i] & KNOWN_DELETED_BIT) == 0);
