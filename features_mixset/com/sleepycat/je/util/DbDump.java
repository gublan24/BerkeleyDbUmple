...
// line 52 ../../../../DbDump.ump
  private static final String usageString = "usage: " + CmdUtil.getJavaCommand(DbDump.class) + "\n"
    ...
    public DbDump(Environment env, String dbName, PrintStream outputFile, String outputDirectory,
	...
	if (dumper.doScavengerRun) {
	    ...
	    dumper = new DbScavenger(dumper.env, dumper.outputFile, dumper.outputDirectory, dumper.formatUsingPrintable,
		    dumper.doAggressiveScavengerRun, dumper.verbose);
